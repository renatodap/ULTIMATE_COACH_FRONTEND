    ...
    <div className="min-h-screen py-16 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="card-glass p-8 space-y-6 text-iron-white">
          <section>
            <h2 className="text-2xl font-bold text-iron-orange mb-4">1. Information We Collect</h2>
            <div className="space-y-4 text-iron-gray leading-relaxed">
              <div>
                <h3 className="text-lg font-semibold text-iron-white mb-2">Personal Information</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-iron-white mb-2">Health & Fitness Data</h3>
                <ul className="list-disc list-inside space-y-2 pl-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-iron-white mb-2">Usage Data</h3>
                <ul className="list-disc list-inside space-y-2 pl-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-iron-orange mb-4">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-iron-orange mb-4">3. AI Processing & Third-Party Services</h2>
            <div className="space-y-4 text-iron-gray leading-relaxed">
              <div>
              ...
              <div>
                <h3 className="text-lg font-semibold text-iron-white mb-2">Supabase (Database & Storage)</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold text-iron-white mb-2">Third-Party Integrations</h3>
                <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-iron-orange mb-4">4. Data Security</h2>
            <div className="space-y-3 text-iron-gray leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-iron-orange mb-4">5. Data Sharing</h2>
            <div className="space-y-3 text-iron-gray leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-iron-orange mb-4">6. Your Data Rights</h2>
            <div className="space-y-3 text-iron-gray leading-relaxed">
              ...
              <p className="pt-2">
                To exercise these rights, contact us at <a href="mailto:privacy@ultimatecoach.com" className="text-iron-orange hover:underline">privacy@ultimatecoach.com</a>
              </p>
            </div>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-iron-orange mb-4">7. Data Retention</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-iron-orange mb-4">9. International Users</h2>
            <p className="text-iron-gray leading-relaxed">
              Your data may be transferred to and processed in countries other than your own. By using ULTIMATE COACH, you consent to the transfer of your information to the United States and other countries where our service providers operate.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-iron-orange mb-4">10. Cookies & Tracking</h2>
            <p className="text-iron-gray leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-iron-orange mb-4">11. Changes to Privacy Policy</h2>
            <p className="text-iron-gray leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-iron-orange mb-4">12. Contact Us</h2>
            <div className="text-iron-gray leading-relaxed space-y-2">
              <p>For privacy-related questions or requests:</p>
              <p>Email: <a href="mailto:privacy@ultimatecoach.com" className="text-iron-orange hover:underline">privacy@ultimatecoach.com</a></p>
              <p>General Support: <a href="mailto:support@ultimatecoach.com" className="text-iron-orange hover:underline">support@ultimatecoach.com</a></p>
            </div>
          </section>
