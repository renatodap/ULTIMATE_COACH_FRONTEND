...
/**
 * Edit Meal Timing Preferences Modal
 *
 * Allows users to update their meal timing preferences
 * Reuses MealTimesSelector from onboarding
 */
...
interface EditMealTimingModalProps {
...
export default function EditMealTimingModal({
  profile,
  isOpen,
  onClose,
  onSuccess,
  onError,
}: EditMealTimingModalProps) {
  const [mealTimes, setMealTimes] = useState<MealTimingPreference[]>(
    (profile.meal_timing_preferences || []).map(mt => ({
      meal_time_id: mt.meal_time_id,
      typical_portion_size: mt.typical_portion_size,
      flexibility_minutes: mt.flexibility_minutes,
      ...
      <div className="bg-iron-dark-gray border border-iron-gray rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-iron-dark-gray border-b border-iron-gray p-4 sm:p-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-heading text-iron-white uppercase tracking-wider">Meal Timing Preferences</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-4 sm:p-6">
          <p className="text-sm text-iron-gray mb-6">
            Set your typical meal times and preferences. We&apos;ll schedule workouts around your meals.
          </p>
